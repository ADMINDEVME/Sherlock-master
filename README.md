...
```console
# clone the repo
$ git clone https://github.com/AdminMaxBomz/Sherlock-master.git
...
## USE
```
1> To search for only one user 🐧

python3 sherlock --timeout 1 user123

2> To search for more than one user:

python3 sherlock user1 user2 user3
```

## LINK VIDEO 🐧
https://www.youtube.com/watch?v=KdZvxxLsN3E&t=192s
